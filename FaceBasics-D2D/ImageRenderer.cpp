...
{
	this->DrawFaceFrameResults(iFace, pFaceBox, pFacePoints, pFaceRotation, pFaceProperties, pFaceTextLayout, nullptr);
}
...
void ImageRenderer::DrawFaceFrameResults(int iFace, const RectI* pFaceBox, const PointF* pFacePoints, const Vector4* pFaceRotation, const DetectionResult* pFaceProperties, const D2D1_POINT_2F* pFaceTextLayout, const ColorSpacePoint* pFaceHDColors)
{
