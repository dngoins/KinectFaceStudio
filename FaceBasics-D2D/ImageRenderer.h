...
public:
	...
	static const int       HD_COLOR_SPACE_COUNT = 1347;
	...
	void DrawFaceFrameResults(int iFace, const RectI* pFaceBox, const PointF* pFacePoints, const Vector4* pFaceRotation, const DetectionResult* pFaceProperties, const D2D1_POINT_2F* pFaceTextLayout, const ColorSpacePoint* pFaceColors);
	bool			m_drawFaceBox;
